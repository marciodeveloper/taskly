...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas abaixo contêm as mensagens padrão usadas pelas regras de
    | validação. Alguns campos, como o de tamanho, têm várias versões:
    | a mensagem escolhida depende do tipo do valor enviado.
    |
    */
    ...
    'between' => [
        ...
        'file' => 'O arquivo em :attribute deve ter entre :min e :max kilobytes.',
    ...
    'gt' => [
        ...
        'file' => 'O arquivo em :attribute deve ter mais de :value kilobytes.',
        'numeric' => 'O campo :attribute deve ser maior que :value.',
        'string' => 'O campo :attribute deve ter mais de :value caracteres.',
    ],
    'gte' => [
        'array' => 'O campo :attribute deve conter :value itens ou mais.',
        'file' => 'O arquivo em :attribute deve ter :value kilobytes ou mais.',
    ...
    'lt' => [
        ...
        'file' => 'O arquivo em :attribute deve ter menos de :value kilobytes.',
        'numeric' => 'O campo :attribute deve ser menor que :value.',
        'string' => 'O campo :attribute deve ter menos de :value caracteres.',
    ],
    'lte' => [
        'array' => 'O campo :attribute não pode conter mais de :value itens.',
        'file' => 'O arquivo em :attribute deve ter :value kilobytes ou menos.',
    ...
    'min' => [
        ...
        'file' => 'O arquivo em :attribute deve ter pelo menos :min kilobytes.',
    ...
    'size' => [
        ...
        'file' => 'O arquivo em :attribute deve ter :size kilobytes.',
    ...
    |--------------------------------------------------------------------------
    |
    | Aqui é possível definir mensagens específicas para a combinação de um
    | atributo com uma regra, usando a convenção "atributo.regra".
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Os nomes dos campos do payload continuam em inglês por serem contrato da
    | API. O mapeamento abaixo existe apenas para que as mensagens exibidas ao
    | usuário soem naturais em português.
    |
    */
